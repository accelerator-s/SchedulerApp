...
void SchedulerApp::connect_signals() {
    ...
    if(register_window) register_window->signal_delete_event().connect([](GdkEventAny*){ return false; });
    ...
    if(help_window) help_window->signal_delete_event().connect([](GdkEventAny*){ return false; });
